                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Type - Habit type selector (Daily / Weekly)
  ...
  Future<void> _saveHabit() async {
    ...
    if (_selectedTime == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please select a time for your habit'),
...
class _TimePicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (hasTime) {
      ...
      displayText = DateFormat.jm().format(dateTime);
    } else {
...
/// Segmented button for selecting habit type (Daily or Weekly).
